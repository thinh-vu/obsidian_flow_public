...
| urgency       | Mức độ cấp thiết của ghi chú. Sử dụng giá trị nhị phân là 1 và 0 trong đó 1 là khẩn cấp, 0 là không khẩn cấp.    | Number           | 1, 0 hoặc 5, 4, 3, 2, 1 nếu muốn chi tiết hơn                                                            | Việc này giúp người dùng không phải gõ important hay unimportant dễ sai từ và dài dòng. Sử dụng kết hợp tiêu chí `impact` sẽ hình thành bộ tiêu chí cho [ma trận khẩn cấp - quan trọng  Eisenhower](https://todoist.com/productivity-methods/eisenhower-matrix). |
| tags          | Thẻ liên quan đến nội dung                                                                                       | List             | "#topic/python", "#tips", "#topic/programming"                                                           | Sử dụng tham chiếu hệ thống thẻ từ hướng dẫn [8. Chiến lược sử dụng tag trong phương pháp FLOW](8.%20Chiến%20lược%20sử%20dụng%20tag%20trong%20phương%20pháp%20FLOW.md)                                                                                           |
...
- **Trong Track**:
	...
	- Ví dụ: `date: 15-09-2024`, `tags: #format/journal, #format/journal`, `category: personal`, `mood: neutral`.
...
- **Trong Blueprint**:
    ...
    - Ví dụ: `aliases: Project Master Plan`, `tags: #strategy, #format/plan`, `category: work`.
...
- **Trong Exhibit**:
    ...
    - Ví dụ: `publish: 28-09-2024 20:30`, `tags: #status/done, #public`, `category: finished work`.
...
- **Trong Vault**:
    ...
    - **tags** có thể dùng để đánh dấu như `#system/template`, `#system`, `#source` để dễ tìm kiếm và tổ chức.
    - Ví dụ: `created: 15-08-2024`, `tags: #system/template