...
2. **Bước 2: Chỉ định thư mục chứa Template**
   - Trong Vault mẫu, thư mục `Vault/templates` được sử dụng làm nơi chứa tất cả mẫu ghi chú sẽ được chèn trong Obsidian. Bạn có thể thay đổi địa chỉ thư mục này theo sở thích của mình.
