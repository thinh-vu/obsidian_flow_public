...
- **Áp dụng properties quan trọng** như `status`, `tags`, `category` để hỗ trợ việc tìm kiếm và tổ chức.
    _Ví dụ:_ Sử dụng `progress: medium` cho các ghi chú đang phát triển trong **Forge**.
- **Sử dụng thẻ (tags) có ý nghĩa** để kết nối các ghi chú theo chủ đề hoặc dự án.
    _Ví dụ:_ Gắn thẻ `#topic/psychology` cho các ghi chú liên quan đến tâm lý học trong **Exhibit**.
...
- **Sử dụng thẻ tạm thời** như `#review/to-review` để đánh dấu những ghi chú cần xem lại.
