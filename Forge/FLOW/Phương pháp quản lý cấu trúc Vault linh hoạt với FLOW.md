...
- **Tags**: Được sử dụng để phân loại thông tin một cách mềm mại, không bị giới hạn bởi cấu trúc thư mục. Một ghi chú có thể nằm trong **Forge** (đang phát triển). Bạn có thể sử dụng các tag như **#project**, **#format/meeting** để dễ dàng tìm kiếm theo ngữ cảnh cụ thể.
